class ProductoController extends ProductoModel {
    ...
    async guardarProducto(producto) {
        const productoGuardado = await productoService.guardarProductosService(producto);

        this.productos.push(productoGuardado);

        renderTablaAlta(alta, this.productos);
    }
    ...
    async actualizarProducto(id) {
        ...
        const productoActualizado = await productoService.actualizarProductosService(id, producto);
    ...
    async borrarProducto(id) {
        ...
        let productoBorrado = await productoService.borrarProductosService(id);
