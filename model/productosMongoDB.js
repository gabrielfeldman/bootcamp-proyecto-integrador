...
pk = '_id'
    ...
    async conectarDB() {
        ...
        try {
            await mongoose.connect(process.env.URI_MONGODB_REMOTA) // URI_MONGODB_LOCAL
    ...
    async createProducto(producto) {
        ...
        try {
            ...
            const productos = await ProductoModel.find({}).lean() // convertir objeto mongoose en un obj de vanilla js
    ...
    async readProducto(id) {
        ...
        try {
            const producto = await ProductoModel.findById(id).lean() // convertir objeto mongoose en un obj de vanilla js
    ...
    async updateProducto(id, producto) {
        ...
        try {
            ...
            const productoActualizado = await ProductoModel.findById(id).lean() // // convertir objeto mongoose en un obj de vanilla js
